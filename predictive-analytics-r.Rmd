...
To conclude the predictive analytics tutorial, let us match out our generated predictions to the real stock closing prices from October 1 to the present date. 

```{r Values}
data2 <- getSymbols("AAPL", src="yahoo", from="2021-10-15", auto.assign=FALSE)
